		...
		<body className="bg-beige">
			<div className="section">
				...
				<p> Forskjellen mellom en god og en dårlig strømavtale kan variere avhengig av individuelle preferanser og behov. Generelt sett kan følgende faktorer bidra til å skille mellom dem:
					...
					Pris: En god strømavtale vil ha konkurransedyktige priser og lave kostnader per kilowattime (kWh). Det er viktig å sammenligne priser fra ulike strømleverandører for å sikre at du får en avtale som passer budsjettet ditt.
